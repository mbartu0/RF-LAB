...
def figMetaData(file_path):
    ...
    if not img_doc.has_exif:
        ...
        latitude = convertGPScoordinate(img_doc.gps_latitude, img_doc.gps_latitude.ref)
        longitude = convertGPScoordinate(img_doc.gps_longitude, img_doc.gps_longitude.ref)
...
if __name__ == "__main__":
    parser = optparse.OptionParser("Usage: python Zadatak.py -f hotel.jpeg")
